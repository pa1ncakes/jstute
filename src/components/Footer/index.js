...
const Footer = () => {
  ...
  return (
    <footer className="mt-16 rounded-2xl bg-light dark:bg-accentDark/90 m-2 sm:m-10 flex flex-col items-center text-dark dark:text-light">
      ...
      <div className="w-full  mt-16 md:mt-24 relative font-medium border-t border-solid border-light py-6 px-8 flex  flex-col md:flex-row items-center justify-between">
        <span className="text-center">
          &copy;2023 pa1ncakes. All rights reserved.
        </span>
        <Link
          href="/sitemap.xml"
        ...
        <div className="text-center">
          Made with &hearts; by{" "}
          <a
            href="https://github.com/pa1ncakes"
            className="underline"
            target="_blank"
          >
            pa1ncakes
